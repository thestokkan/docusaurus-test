...
<details><summary><strong>Code assistance:</strong> Calculating age from personal identification number</summary>
<p>
...
#### Add directory `wwwroot`` and upload image in Designer"
